...
print('<head>')
print(
   '<meta HTTP-EQUIV="REFRESH" content="0; url=http://rentalsearch.hopto.org:1234/main/search_property.php?location=' + search_loc + '&posted_since=' + str(

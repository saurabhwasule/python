...
def get_url(pge_cnt):
    ...
    if pge_cnt == 1:
        url = "https://m.magicbricks.com/mbs/property-for-rent/residential-real-estate?proptype=Apartment,Builder-Floor,Penthouse,Studio-Apt." \
              "&cityName=" + city + "&Locality=" + str(loc) + "&&pageOption=B&parameter=recent"
        print(url)
    else:
        url = "https://m.magicbricks.com/mbs/property-for-rent/residential-real-estate?proptype=Apartment,Builder-Floor,Penthouse,Studio-Apt." \
              "&cityName=" + city + "&Locality=" + str(loc) + "&&pageOption=B&parameter=recent/Page-" + str(pge_cnt-1)
        print(url)
    return (url)
...
def get_property_details():
    ...
    while (pge_cnt < 10):
        ...
        for item in all:
            ...
            try:
                ...
                # if search_loc and not search_loc.isspace():
    ...
    # else:
    #     print("No record found in magic bricks.")

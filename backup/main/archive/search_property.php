...
?>
              ...
              <div class="form-group">
                ...
                <select  class="form-control" id="srtbyslct" name="sort_by">
                  <option value="">--</option>
                    <option value='owner'>Owner Properties</option>
                    <option value='price_high_to_low'>Price High to Low</option>
                    <option value='price_low_to_high'>Price Low to High</option>
                </select>
              </div>
              <button type="submit" name="button" id="button" value="Search" class="btn btn-default">Search</button>
            </div>
          </form>
          <br/>
          <table class="table users" border="1" >
			...
			//define how many pages number you want to display
			$display_pages = 10;
